...
export const TROOPS: Troop[] = [
  ...
  },
  {
    ...
    chainRange:      1,
    levels: [
      { level: 1, hp: 3400, dps: 260, deathDamage: 260, townHallRequired: 11 },
      { level: 2, hp: 3900, dps: 290, deathDamage: 300, townHallRequired: 11 },
      { level: 3, hp: 4400, dps: 320, deathDamage: 340, townHallRequired: 12 },
      { level: 4, hp: 4700, dps: 350, deathDamage: 380, townHallRequired: 13 },
      { level: 5, hp: 5000, dps: 380, deathDamage: 420, townHallRequired: 13 },
      { level: 6, hp: 5400, dps: 410, deathDamage: 460, townHallRequired: 14 },
      { level: 7, hp: 5700, dps: 440, deathDamage: 500, townHallRequired: 14 },
      { level: 8, hp: 6200, dps: 460, deathDamage: 540, townHallRequired: 15 },
      { level: 9, hp: 6700, dps: 500, deathDamage: 580, townHallRequired: 16 },
    ],
  },
];
