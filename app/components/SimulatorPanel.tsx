    ...
    <div className="mx-auto max-w-6xl px-6 py-10 space-y-8">
      ...
      {showCalibration && pendingRec && (
        <RecognitionCalibrationModal
          ...
          rawWallRings={pendingRec.rawWallRings}
    ...
    >
      ...
      <svg className="absolute inset-0 pointer-events-none" style={{ zIndex: 2 }} width="100%" height="100%">
        ...
        {placementMode && placedSpells?.map((ps) => {
          ...
          const color   = isRage ? "#ec4899" : "#06b6d4";
        ...
        <div className="flex flex-wrap gap-2">
          {(["rage", "freeze"] as const).map((spellId) => {
            ...
            const selCls  = isRage
              ...
              : "border-cyan-500 bg-cyan-500/15 text-cyan-300";
            const txtCls  = isRage ? "text-pink-400" : "text-cyan-400";
            return (
      ...
      {placedSpells.length > 0 && (
        <div className="space-y-1">
          ...
          <div className="max-h-24 overflow-y-auto space-y-1">
            {placedSpells.map((ps) => {
              const isRage = ps.spellId === "rage";
              const color  = isRage ? "text-pink-400" : "text-cyan-400";
              const name   = isRage ? "Rage" : "Gel";
              return (
